...
<div class="top">
<div >
<form action="<%=request.getContextPath()%>/user?method=searchAllBook"  method="post">
<div class="panel">
 <div >
...
<th class="tableForm-inner-th">是否借出</th>
</tr></thead>
...
<td   class="tableForm-inner-td">${f.book_borrow}</td>
